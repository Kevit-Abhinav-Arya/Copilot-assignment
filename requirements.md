...
|---|---|
|File|Role|
|`[ui-agent.agent.md](http://ui-agent.agent.md)`|Frontend specialist — HTML, CSS, vanilla JS, loading states, error toasts|
|`[backend-agent.agent.md](http://backend-agent.agent.md)`|Backend specialist — validation, HTTP status codes, business logic, docs|
|`[testing-agent.agent.md](http://testing-agent.agent.md)`|Testing specialist — unit tests, E2E tests, >80% coverage|
